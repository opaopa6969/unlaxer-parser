...
class DAPProtocolEmitter {
    ...
    static void emitLaunch(IndentedWriter w) {
        ...
        w.indent();
        w.line("pendingProgram = (String) args.getOrDefault(\"program\", \"\");");
        w.line("runtimeMode = String.valueOf(args.getOrDefault(\"runtimeMode\", \"token\"));");
        w.line("stopOnEntry = Boolean.TRUE.equals(args.get(\"stopOnEntry\"));");
