# 査読会話劇: "From Grammar to IDE" v1 査読プロセス
...
**後輩:** それとR2は、Spoofax、Xtext、JetBrains MPSとの定量比較も求めていますが...
...
**後輩:** 二つ目。モナディック対応関係は認めた方が強い。隠すと「知らない」と思われる。

**先輩:** 三つ目。JMHを使わないベンチマークは2024年以降は通用しない。

**後輩:** 四つ目。N=1でも論文は書けるが、合成ベンチマークでスケーラビリティを補強すべき。

**先輩:** 五つ目。「お前のコードは動くんか？」は査読者に言ってはいけない。

**後輩:** それは最初から分かっていたことでは...。
